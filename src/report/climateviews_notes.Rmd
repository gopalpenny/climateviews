...
* [Natural Hazards Index Map (Earth Institute at Columbia)](https://ncdp.columbia.edu/library/mapsmapping-projects/us-natural-hazards-index/)
...
* [US Drought Monitor](https://droughtmonitor.unl.edu/Data/DataDownload/ComprehensiveStatistics.aspx), and [API info](https://droughtmonitor.unl.edu/WebServiceInfo.aspx#comp)
* [FEMA NFIP](https://www.fema.gov/media-library/assets/documents/180374)
...
mit_county <- read_csv("../../data/format/mit_election_18.csv") %>% 
  mutate(obama12_pct= 100 * obama12 / (romney12 + obama12 + otherpres12),
